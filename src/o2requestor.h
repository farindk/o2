...
Q_SIGNALS:
    ...
    /// Emitted when a request has been completed or failed. Includes HTTP status code and reply headers.
    void finished(int id, int httpStatusCode, QNetworkReply::NetworkError error, QString errorText, QByteArray data, QList<QNetworkReply::RawHeaderPair> headers);
